                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <motion.a
                                href="https://github.com/VirajGurbade03/GoVio-Website/releases/download/v1.0/app-release.apk"
                                download
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                            ...
                            <div className="flex items-center space-x-6">
                                <div className="relative group">
                                    <div className="w-24 h-24 bg-white rounded-xl flex items-center justify-center shadow-lg p-2 transition-transform group-hover:scale-105">
                                        <img
                                            src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent('https://github.com/VirajGurbade03/GoVio-Website/releases/download/v1.0/app-release.apk')}`}
